...
-- 插入菜单
-- ----------------------------
INSERT INTO uni_boot_dev.sys_menu (id, parent_id, route_name, route_path, component_path, menu_name, leaf_flag, icon,
...
-- 插入字典
-- ----------------------------
INSERT INTO uni_boot_dev.sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
