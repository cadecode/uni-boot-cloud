...
INSERT INTO sys_role (id, code, name, type, description)
    VALUE (1, 'admin', '管理员用户', 'ACCESS', '管理员权限');
INSERT INTO sys_role (id, code, name, type, description)
    VALUE (2, 'manager', '高级用户', 'ACCESS', '高级用户权限');
INSERT INTO sys_role (id, code, name, type, description)
    VALUE (3, 'normal', '普通用户', 'ACCESS', '普通用户权限');
-- ----------------------------
-- 插入菜单
-- ----------------------------
...
VALUES (307, 3, 'EchartsDemo', '/develop/echarts', '/Develop/Echarts', 'Echarts 示例', 1, null, 307, 1, 0, 0,
        '2023-08-18 15:03:30', '2023-11-09 16:46:04', 'admin');
INSERT INTO sys_menu (id, parent_id, route_name, route_path, component_path, menu_name, leaf_flag, icon, order_num,
                      enable_flag, hidden_flag, cache_flag, create_time, update_time, update_user)
...
VALUES (1, '日志类型', 'logType', '查询', 'Query', '日志类型-查询', 0, 0, '2023-06-11 23:24:26', '2023-06-12 00:11:57',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (2, '日志类型', 'logType', '删除', 'Remove', '日志类型-删除', 1, 0, '2023-06-11 23:24:52', '2023-06-12 00:12:01',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (3, '日志类型', 'logType', '更新', 'Update', '日志类型-更新', 2, 0, '2023-06-11 23:25:08', '2023-06-12 00:12:05',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (4, '日志类型', 'logType', '添加', 'Add', '日志类型-添加', 3, 0, '2023-06-11 23:25:29', '2023-06-12 00:12:09',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (5, '日志类型', 'logType', '鉴权', 'Auth', '日志类型-鉴权', 4, 0, '2023-06-11 23:25:45', '2023-06-12 00:12:15',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (6, '日志类型', 'logType', '导入', 'Import', '日志类型-导入', 5, 0, '2023-06-11 23:25:58', '2023-06-12 00:12:19',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (7, '日志类型', 'logType', '导出', 'Export', '日志类型-导出', 6, 0, '2023-06-11 23:26:09', '2023-06-12 00:12:30',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (8, '日志类型', 'logType', '上传', 'Upload', '日志类型-上传', 7, 0, '2023-06-11 23:26:26', '2023-06-12 00:12:35',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
...
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (10, '日志类型', 'logType', '其他', 'Other', '日志类型-其他', 9, 0, '2023-06-11 23:26:49', '2023-06-12 00:52:14',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
...
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
VALUES (14, 'MQ消息发送状态', 'mqMsgSendState', '失败', 'FAIL', 'MQ 消息发送失败', 2, 1, '2023-08-22 23:26:04',
        '2023-08-24 10:20:51',
        'admin');
INSERT INTO sys_dict (id, name, type, label, value, description, order_num, default_flag, create_time,
                      update_time, update_user)
