package com.github.cadecode.uniboot.framework.base.aspect;
...
public class ApiInnerAspect {
    ...
    @Pointcut("@annotation(com.github.cadecode.uniboot.framework.base.annotation.ApiInner)")
    ...
    public void rateLimit(JoinPoint point) {
        ...
        boolean innerFlag = ObjUtil.equal(source, HttpConst.HEAD_SOURCE_VALUE);
        // 判断是否仅供内部调用
